...
const textures = () => {
    ...
    loadingManager.onLoad = () => {
        ...
        // You can perform additional tasks here once all assets are loaded
    };

    loadingManager.onProgress = (item, loaded, total) => {
        console.log(`Loading progressing: ${Math.floor((loaded / total) * 100)}%`);
    };

    loadingManager.onError = (url) => {
        console.error(`Error loading ${url}`);
        // Additional error handling, such as retrying or displaying an error message
    };
